...
#(4032, 4637, 2743, 5866, 1032, 5155, 2410)"
##for row in c.execute("""select title, id, author from
##book where author like '%Updike%'"""):
##	print(str(row))

### get sentence lengths
##query = """SELECT length from sentence """
##
##
# get books and indices
book_ids = [4032,4637]
...
##matrix = [[], []]
##
##def for i in range(len(mentions)):
